...
// Get the current version of code
pub const VERSION: &str = env!("CARGO_PKG_VERSION");

fn main() {
    log!("code started", "code has just been started");
    ...
    let config_dir = load_config().unwrap_or_else(|| " ~/.config/code/code.ron".to_string());
    // Gather the command line arguments
    let cli = App::new("code")
        .version(VERSION)
        .author("Author: Victor Vasquez")
